...
class game:
    def __init__(self):
        ...
        self.character = char([("images/Animations/Idle/ScarlettIdle1.png", 0.2),("images/Animations/Idle/ScarlettIdle2.png", 0.2),("images/Animations/Idle/ScarlettIdle3.png", 0.2),("images/Animations/Idle/ScarlettIdle4.png", 0.2),("images/Animations/Idle/ScarlettIdle5.png", 0.2),
                            ...
                            ("images/Animations/Run/ScarlettRun6.png", 0.15),("images/Animations/Run/ScarlettRun7.png", 0.15),("images/Animations/Run/ScarlettRun8.png", 0.15),("images/Animations/Run/ScarlettRun1_left.png", 0.15),("images/Animations/Run/ScarlettRun2_left.png", 0.15),
                            ("images/Animations/Run/ScarlettRun3_left.png", 0.15),("images/Animations/Run/ScarlettRun4_left.png", 0.15),("images/Animations/Run/ScarlettRun5_left.png", 0.15),("images/Animations/Run/ScarlettRun6_left.png", 0.15),("images/Animations/Run/ScarlettRun7_left.png", 0.15),("images/Animations/Run/ScarlettRun8_left.png", 0.15)],
                            [('images/Animations/Idle/ScarlettNIdle1.png',0.2),('images/Animations/Idle/ScarlettNIdle2.png',0.2),('images/Animations/Idle/ScarlettNIdle3.png',0.2),('images/Animations/Idle/ScarlettNIdle4.png',0.2),('images/Animations/Idle/ScarlettNIdle5.png',0.2),('images/Animations/Walk/Walk1.png',0.001),('images/Animations/Walk/Walk2.png',0.2),('images/Animations/Walk/Walk3.png',0.2),('images/Animations/Walk/Walk4.png',0.2),('images/Animations/Walk/Walk5.png',0.2),('images/Animations/Walk/Walk6.png',0.2),('images/Animations/Walk/Walk7.png',0.2),('images/Animations/Walk/Walk8.png',0.2)],
                            [('images/Animations/Switch/SwitchAnim1.png',0.2),('images/Animations/Switch/SwitchAnim2.png',0.2),('images/Animations/Switch/SwitchAnim3.png',0.2),('images/Animations/Switch/SwitchAnim4.png',0.2),('images/Animations/Switch/SwitchAnim5.png',0.2),('images/Animations/Switch/SwitchAnim6.png',0.2),('images/Animations/Switch/SwitchAnim7.png',0.2)],
                            15,340)
    ...
    def menu(self):
        ...
        bg=pygame.image.load("images/Backgrounds/Intro_1.png").convert()
        self.title=pyganim.PygAnimation([('images\Animations\FX\MainScreen1.png',.1),('images\Animations\FX\MainScreen2.png',.12),('images\Animations\FX\MainScreen3.png',.15),('images\Animations\FX\MainScreen4.png',.17),('images\Animations\FX\MainScreen5.png',.2)])
        self.title.play()
        start1=pygame.image.load('images\Animations\FX\Start1.png').convert_alpha()
        start2=pygame.image.load('images\Animations\FX\Start2.png').convert_alpha()
        Quit1=pygame.image.load('images\Animations\FX\Quit1.png').convert_alpha()
        Quit2=pygame.image.load('images\Animations\FX\Quit2.png').convert_alpha()
        start=0
        done=False
        while not done:
            ...
            self.D_SURF.blit(bg,(0,0))

            self.title.blit(self.D_SURF,(50,125))

            if start == 0:
                self.D_SURF.blit(start2,(-15,325))
                self.D_SURF.blit(Quit1,(95,425))

            else:
                self.D_SURF.blit(start1,(-25,325))
                self.D_SURF.blit(Quit2,(100,425))
    ...
    def level_0(self):
        ...
        currentLevel = level.level(["images/Backgrounds/Intro_1.png", "images/Backgrounds/Intro_1.png"],[],[plat1,plat2,plat5,plat7,plat8,plat9],True)
        ...
        while not LEVEL_0_DONE:
            ...
            for event in pygame.event.get():
                ...
                #Keydown
                    ...
                    if event.key == pygame.K_UP and self.character.happy:
           ...
           # self.character.textgroup.draw(self.D_SURF)
            ...
            if self.character.level == 1:
             ...
             #change surf
            changeimage=pygame.image.load('images/Backgrounds/changestate.png').convert()
            if  not self.character.happy:
                changeimage.set_alpha(75)
                self.D_SURF.blit((changeimage),(0,0))
    ...
    def level_1(self):
        ...
        currentLevel = level.level(["images/Backgrounds/Level_1-2_Final Good.png", "images/Backgrounds/Level_1-2_Final Bad.png"],[],[plat01,plat02,plat03,plat04,plat05,
        ...
        while not LEVEL_1_DONE:
            ...
            ghostiscollided=pygame.sprite.collide_rect(self.character,self.ghost)
            print(ghostiscollided)
            if ghostiscollided:
                pygame.time.wait(200)
                self.character.happy=True
                currentLevel.toggleState()
                self.character.restart()
                self.spritemove(currentLevel.platGroup,checkGroup,enndGroup,currentLevel.platGroup,currentLevel.platGroup)
